...
package com.android.server.profiles;
...
import com.android.internal.util.lineageos.app.IProfileManager;
...
public class ProfileManagerService extends SystemService {
    ...
    public ProfileManagerService(Context context) {
        ...
        //        ContextConstants.Features.PROFILES)) {
            publishBinderService(ContextConstants.LINEAGE_PROFILE_SERVICE, mService);
        //} else {
...
/*    @Override
    public String getFeatureDeclaration() {
        return ContextConstants.Features.PROFILES;
    }*/
    ...
    public void onStart() {
        ...
        mWildcardGroup = new NotificationGroup(
                mContext.getString(R.string.wildcardProfile),
                R.string.wildcardProfile,
                mWildcardUUID);
    ...
    private final IBinder mService = new IProfileManager.Stub() {
        ...
        public Profile[] getProfiles() {
            ...
            for (Profile profile : profiles) {
                Log.v("Profile","Profile: "+profile.toString());
            }
    ...
    private void enforceChangePermissions() {
        mContext.enforceCallingOrSelfPermission( Manifest.permission.MODIFY_PROFILES,
    ...
    private void initialiseStructure() throws XmlPullParserException, IOException {
        XmlResourceParser xml = mContext.getResources().getXml( com.android.internal.R.xml.profile_default);
        try {
