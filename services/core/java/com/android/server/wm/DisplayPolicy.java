...
public class DisplayPolicy {
    ...
    public void onConfigurationChanged() {
        ...
        final int uiMode = mService.mPolicy.getUiMode();
        final boolean showNavbar = XtendedUtils.shouldShowGestureNav(mContext);
    ...
    private boolean gestureNavbarHidden() {
        boolean isGestureNavbar = (XtendedUtils.isThemeEnabled("com.android.internal.systemui.navbar.gestural")
