...
import com.android.internal.util.lineageos.os.Concierge;
import com.android.internal.util.lineageos.os.Concierge.ParcelInfo;
...
public final class Profile implements Parcelable, Comparable {
    ...
    public String toString() {
        return "Profile{" +
                ...
                ", mUuid=" + mUuid +
                ", mSecondaryUuids=" + mSecondaryUuids +
                ", profileGroups=" + profileGroups +
                ", mDefaultGroup=" + mDefaultGroup +
                ", mStatusBarIndicator=" + mStatusBarIndicator +
                ", mDirty=" + mDirty +
                ", mProfileType=" + mProfileType +
                ", streams=" + streams +
                ", mTriggers=" + mTriggers +
                ", connections=" + connections +
                ", networkConnectionSubIds=" + networkConnectionSubIds +
                ", mRingMode=" + mRingMode +
                ", mAirplaneMode=" + mAirplaneMode +
                ", mBrightness=" + mBrightness +
                ", mScreenLockMode=" + mScreenLockMode +
                ", mExpandedDesktopMode=" + mExpandedDesktopMode +
                ", mDozeMode=" + mDozeMode +
                ", mNotificationLightMode=" + mNotificationLightMode +
                '}';
    }
    ...
    public void doSelect(Context context, IKeyguardService keyguardService) {
        ...
        /*fix me if (keyguardService != null) {
