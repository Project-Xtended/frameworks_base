...
public class KeyguardSliceProvider extends SliceProvider implements
    ...
    private XPSettingsObserver mXPSettingsObserver;

    private class XPSettingsObserver extends ContentObserver {
        XPSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    public boolean onCreateSliceProvider() {
        ...
        mXPSettingsObserver = new XPSettingsObserver(mHandler);
        mXPSettingsObserver.observe();
        mXPSettingsObserver.updateDateSkeleton();
        sInstance = this;
        registerClockUpdate();
        updateClock();
        return true;
