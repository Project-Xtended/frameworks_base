...
public class CurrentWeatherView extends FrameLayout implements OmniJawsClient.OmniJawsObserver {
	...
	mRightTextColor = Settings.System.getIntForUser(getContext().getContentResolver(),
        ...
        if (omniLeftTextFont == 31) {
            mLeftText.setTypeface(Typeface.create("samsung-sys", Typeface.NORMAL));
        }
        ...
        if (omniRightTextFont == 31) {
            mRightText.setTypeface(Typeface.create("samsung-sys", Typeface.NORMAL));
        }
    }
