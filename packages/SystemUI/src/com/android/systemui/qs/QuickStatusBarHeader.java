...
public class QuickStatusBarHeader extends RelativeLayout implements
    ...
    // QS Logo
    private ImageView mXtendedQsLogo;
    private ImageView mXtendedQsLogoRight;
    private int mQsLogoStyle;
    private int mQsShowLogo;
    private int mQsLogoColor;
    private boolean mCustomQsLogoEnabled;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
		    ...
		    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                   .getUriFor(Settings.System.CUSTOM_QS_LOGO_ENABLED), false,
                   this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
    ...
    protected void onFinishInflate() {
        ...
        mXtendedQsLogo = findViewById(R.id.qs_panel_logo);
	mXtendedQsLogoRight = findViewById(R.id.qs_panel_logo_right);
    ...
    public void updateLogoSettings() {
        ...
        mQsShowLogo = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_PANEL_LOGO, 0,
                UserHandle.USER_CURRENT);
        mQsLogoColor = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_PANEL_LOGO_COLOR, 0xffff8800,
                UserHandle.USER_CURRENT);
        mQsLogoStyle = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.QS_PANEL_LOGO_STYLE, 0,
                UserHandle.USER_CURRENT);

        mCustomQsLogoEnabled = Settings.System.getIntForUser(
                mContext.getContentResolver(), Settings.System.CUSTOM_QS_LOGO_ENABLED, 0,
                UserHandle.USER_CURRENT) == 1;

        final String customQsLogoURI = Settings.System.getStringForUser(
                mContext.getContentResolver(), Settings.System.CUSTOM_QS_LOGO_IMAGE,
                UserHandle.USER_CURRENT);

        if (!TextUtils.isEmpty(customQsLogoURI) && mCustomQsLogoEnabled) {
            try {
                ParcelFileDescriptor parcelFileDescriptor =
                    getContext().getContentResolver().openFileDescriptor(Uri.parse(customQsLogoURI), "r");
