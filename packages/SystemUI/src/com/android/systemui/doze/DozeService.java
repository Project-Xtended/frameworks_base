...
public class DozeService extends DreamService
    ...
    private void deviceSpecificPerfermanceModeHandler(boolean enabled) {
        if(getUltraPowerSavingMode() && XtendedUtils.IntelligentPerformanceProfileAvailable()) {
            if(enabled) {
                XtendedUtils.SetLastPerformanceProfileToSettings(this, SystemProperties.get(SPECTRUM_SYSTEM_PROPERTY, Resources.getSystem().getString(R.string.config_balanced_profile)));
                SystemProperties.set(SPECTRUM_SYSTEM_PROPERTY, Resources.getSystem().getString(R.string.config_screen_off_profile));
            } else {
                SystemProperties.set(SPECTRUM_SYSTEM_PROPERTY, XtendedUtils.GetLastPerformanceProfileFromSettings(this));
            }
        }
    }
